...
class Dataset:
    ...
    def pick_train_mini_batch(self):
        ...
        train_idxs = train_idxs[:self.batch_size]
    ...
    def pick_dev_mini_batch(self):
        dev_idxs = np.arange(len(self._dev_labels))
        np.random.shuffle(dev_idxs)
        dev_idxs = dev_idxs[:self.batch_size]
        mini_dev1 = self.train_sen1[dev_idxs]
        mini_dev2 = self.train_sen2[dev_idxs]
        mini_labels = self._train_labels[dev_idxs]
        return mini_dev1, mini_dev2, mini_labels
